    ...
    try {
      if (fallCanvas) {
        ...
        if (r && (r.width < 100 || r.height < 100)) {
          ...
          if (fallCanvas.parentNode !== document.documentElement && document.documentElement) {
            document.documentElement.appendChild(fallCanvas);
          }
        }
      }
      ...
      if (accCanvas) {
        ...
        if (r2 && (r2.width < 100 || r2.height < 100)) {
          ...
          if (accCanvas.parentNode !== document.documentElement && document.documentElement) {
            document.documentElement.appendChild(accCanvas);
          }
        }
      }
    } catch (e_pos) {}
